  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/75 md:text-xl max-w-md mx-auto text-lg tracking-tighter text-center mt-5">
            ...
            {[...testimonials, ...testimonials].map((testimonial,index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3 mt-5">
                  <div className="relative after:content-[''] after:absolute after:rounded-lg after:inset-0 after:bg-[rgb(140,69,255)] after:mix-blend-soft-light before:content-[''] before:absolute before:inset-0 before:border before:border-white/30 before:z-10 before:rounded-lg">
                    <Image
